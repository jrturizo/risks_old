<?php
	...
	WHERE CONCAT(c.IdConductor,' ',c.Conductor) like '%".$criterio."%' and s.`Estado_AI` <> 'E' AND ( s.`ESTADO` <> '10' AND s.`ESTADO` <> '12' AND s.`ESTADO` <> '21' AND s.`ESTADO` <> '1'AND s.`ESTADO` <> '21')	Order By c.Conductor ASC LIMIT 0 , 30";
